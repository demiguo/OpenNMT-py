...
def model_opts(parser):
    ...
    group.add_argument("-n_samples", default=10, type=int, help="number of samples for marginalization")
...
def train_opts(parser):
    ...
    group.add_argument('-eval_only', default=0, type=int,
                       help="""Evaluate test ppl only.""")
